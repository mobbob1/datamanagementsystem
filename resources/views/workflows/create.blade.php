<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-white">Create Workflow</h2>
    </x-slot>
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
        <form method="POST" action="{{ route('workflows.store') }}" class="grid grid-cols-1 md:grid-cols-2 gap-4">
            @csrf
            ...
            <div class="md:col-span-2 flex justify-end gap-2">
                <a href="{{ route('workflows.index') }}" class="inline-flex items-center px-4 py-2 rounded-md bg-gray-200 text-gray-800 text-xs uppercase tracking-widest">Cancel</a>
